...
(
    ...
    constraint fk_pizza_board foreign key (board_id) references pizza.t_pizza_boards (id)
);
...
(
    ...
    constraint fk_ingredient foreign key (ingredient_id) references pizza.t_ingredients (id)
);
