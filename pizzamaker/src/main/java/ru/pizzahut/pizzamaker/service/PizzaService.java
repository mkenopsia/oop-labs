...
public class PizzaService {
    ...
    private Pizza processPayload(PizzaPayload payload, Pizza pizza) {
        ...
        List<Ingredient> ingredients = ingredientsRepository.getAllIngredients().stream()
        ...
        pizza.setPrice(evalPrice(ingredients, base, pizzaBoard, pizzaSize));

        return pizza;
    }

    private Double evalPrice(List<Ingredient> ingredients, PizzaBase base, PizzaBoard pizzaBoard, PizzaSize pizzaSize) {
        Double price = 0.0;
